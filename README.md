...
**👉 [`dist/stock-alarm-debug.apk`](dist/stock-alarm-debug.apk)** (약 17 MB, minSdk 26 = Android 8.0+)
...
└── ui/
    ├── nav/                         3탭 BottomBar Navigation + chart/{symbol} 라우트
...
현재 `v0.2.0` (versionCode 2) — 차트 디테일 + 새 앱 아이콘.
