...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_4_5 = object : Migration(4, 5) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE watchlist ADD COLUMN prevPrevMa5 REAL DEFAULT NULL")
                db.execSQL("ALTER TABLE watchlist ADD COLUMN lastExtremaNotifyDate TEXT DEFAULT NULL")
            }
        }
    }
}
